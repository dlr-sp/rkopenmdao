...
def convergence_study(
    ...
    """
    Conducts a convergence study with a time discretization on an ode.
    ...
    base_step_size: float
        Step size from which all other step sizes in the convergence study are derived.
    num_calculation: int
        Number of calculations/step sizes to be tested in the study.
    """
...
def step_duality(
    ...
    """
    Test the duality between compute_step_derivative and
    compute_step_adjoint_derivative.
